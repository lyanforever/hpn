...
def load_cifar100(basedir, batch_size, kwargs):
    ...
    # Labels to torch.
#     trainloader.dataset.target = \
#             torch.from_numpy(np.array(trainloader.dataset.target))
    ...
    testloader = torch.utils.data.DataLoader(
            ...
            batch_size=batch_size, shuffle=True, **kwargs)
    # Labels to torch.
#     testloader.dataset.target = \
#             torch.from_numpy(np.array(testloader.dataset.target))
